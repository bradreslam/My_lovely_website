...
import background  from "../assets/maze_assets/left_tower_background.png";
import telescopeView from "../assets/maze_assets/telescope_view.png"
import "../styling/Maze.css";
import "../styling/LeftTower.css"
...
const LeftTower: React.FC = () => {
    const [telescopeOn, setTelescopeOn] = useState(false);
    ...
    return(
        <div className="flex_box">
            <div className="maze_container">
                <img src={telescopeOn ? telescopeView : background} alt="background" className="background"/>
                <button className="telescope" onClick={() => setTelescopeOn(!telescopeOn)} style={{
                    bottom: telescopeOn ? "0" : "25%",
                    width: telescopeOn ? "100%" : "10%",
                    height: telescopeOn ? "100%" : "10%",
