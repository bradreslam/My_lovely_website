...
const maze_layout:{[key:number]:room} = {
    ...
    8: new room(wall_types.wall,wall_types.gate,null,wall_types.wall,null,null),
    ...
    17: new room(null,null,wall_types.gate,wall_types.gate,null,null),
    18: new room(wall_types.wall,null,wall_types.wall,null,null,new torch(true,Direction.N)),
    19: new room(null,wall_types.gate,wall_types.wall,null,null,null),
    ...
    24: new room(null,wall_types.door3,null,wall_types.wall,null,null),
    25: new room(wall_types.wall,wall_types.wall,wall_types.wall,wall_types.door3,null,null),
    26: new room(null,wall_types.wall,null,wall_types.wall,null,new torch(true, Direction.W)),
    ...
    30: new room(wall_types.wall,null,wall_types.gate,wall_types.gate,null,null),
    31: new room(wall_types.gate,null,null,null,new Interactable(Direction.N,Interactable_types.nest),null),
    32: new room(wall_types.wall,null,wall_types.wall,null,null,new torch(true, Direction.S)),
    33: new room(wall_types.gate,wall_types.wall,null,null,null,null),
