...
const maze_layout:{[key:number]:room} = {
    ...
    4: new room(wall_types.gate,wall_types.gate,wall_types.wall,wall_types.gate,true,null,new torch(false, Direction.S), 4),
    5: new room(wall_types.gate,wall_types.gate,wall_types.wall,wall_types.gate,true,null,new torch(true, Direction.S), 5),
    ...
    9: new room(wall_types.wall,wall_types.gate,wall_types.gate,wall_types.gate,true,null,new torch(true, Direction.N), 9),
    ...
    18: new room(wall_types.wall,wall_types.hall,wall_types.wall,wall_types.hall,false,null,new torch(true,Direction.N), 18),
    ...
    21: new room(wall_types.gate,wall_types.wall,wall_types.gate,wall_types.wall,true,null,new torch(false, Direction.E), 21),
    22: new room(wall_types.wall,wall_types.door2,wall_types.gate,wall_types.wall,true,null,null, 22),
    23: new room(wall_types.gate,wall_types.wall,wall_types.gate,wall_types.door2,true,null,new torch(true, Direction.E), 23),
    ...
    26: new room(wall_types.hall,wall_types.wall,wall_types.hall,wall_types.wall,false,null,new torch(true, Direction.W), 26),
    ...
    37: new room(wall_types.door1,wall_types.gate,wall_types.wall,wall_types.wall,true,null,new torch(true, Direction.W), 37),
    ...
    41: new room(wall_types.wall,wall_types.gate,wall_types.gate,wall_types.gate,true,null,new torch(true, Direction.N), 41),
    ...
    47: new room(wall_types.wall,wall_types.gate,wall_types.gate,wall_types.gate,true,null,new torch(true,Direction.N), 47),
