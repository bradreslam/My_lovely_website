...
const maze_layout:{[key:number]:room} = {
    1: new room(wall_types.hall,wall_types.wall,wall_types.wall,wall_types.wall,false,new Interactable(Direction.N,Interactable_types.stair), null, 1),
    2: new room(wall_types.gate,wall_types.gate,wall_types.wall,wall_types.wall,true,null,null, 2),
    3: new room(wall_types.wall,wall_types.gate,wall_types.wall,wall_types.gate,true,new Interactable(Direction.S,Interactable_types.chest, item.key2), null, 3),
    ...
    6: new room(wall_types.wall,wall_types.wall,wall_types.wall,wall_types.gate,true,new Interactable(Direction.E, Interactable_types.chest, item.map),null, 6),
    7: new room(wall_types.gate,wall_types.wall,wall_types.wall,wall_types.wall,false,new Interactable(Direction.N, Interactable_types.stair),null, 7),
    8: new room(wall_types.wall,wall_types.gate,wall_types.hall,wall_types.wall,true,null,new torch(torch_state.on, Direction.N), 8),
    9: new room(wall_types.wall,wall_types.gate,wall_types.gate,wall_types.gate,true,null,null, 9),
    ...
    13: new room(wall_types.gate,wall_types.gate,wall_types.wall,wall_types.gate,true,null,new torch(torch_state.on, Direction.S), 13),
    14: new room(wall_types.gate,wall_types.wall,wall_types.gate,wall_types.gate,true,null,new torch(torch_state.off,Direction.E), 14),
    15: new room(wall_types.door2,wall_types.wall,wall_types.wall,wall_types.wall,true,new Interactable(Direction.S,Interactable_types.chest,item.egg),null, 15),
    ...
    21: new room(wall_types.gate,wall_types.wall,wall_types.gate,wall_types.wall,true,null,null, 21),
    22: new room(wall_types.wall,wall_types.gate,wall_types.door2,wall_types.wall,true,null,new torch(torch_state.on, Direction.W), 22),
    23: new room(wall_types.gate,wall_types.wall,wall_types.gate,wall_types.gate,true,null,null, 23),
    ...
    35: new room(wall_types.wall,wall_types.wall,wall_types.gate,wall_types.wall,true,new Interactable(Direction.N,Interactable_types.chest,item.compass),null, 35),
    36: new room(wall_types.wall,wall_types.wall,wall_types.gate,wall_types.wall,true,new Interactable(Direction.N,Interactable_types.chest,item.key1),null, 36),
    37: new room(wall_types.gate,wall_types.gate,wall_types.wall,wall_types.wall,true,null,null, 37),
    38: new room(wall_types.wall,wall_types.gate,wall_types.gate,wall_types.gate,true,null,new torch(torch_state.on, Direction.N), 38),
    ...
    43: new room(wall_types.wall,wall_types.door1,wall_types.wall,wall_types.wall,false,new Interactable(Direction.W,Interactable_types.stair),null, 43),
    44: new room(wall_types.wall,wall_types.wall,wall_types.gate,wall_types.door1,true,null,new torch(torch_state.on,Direction.N), 44),
