...
const maze_layout:{[key:number]:room} = {
    ...
    15: new room(wall_types.gate,wall_types.wall,wall_types.wall,wall_types.wall,true,new Interactable(Direction.S,Interactable_types.chest,item.egg),null, 15),
    ...
    37: new room(wall_types.door1,wall_types.gate,wall_types.wall,wall_types.wall,true,null,null, 37),
    ...
    44: new room(wall_types.wall,wall_types.wall,wall_types.gate,wall_types.gate,true,null,new torch(torch_state.on,Direction.N), 44),
